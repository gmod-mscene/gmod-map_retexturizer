...
function Panels:SetDisplacements(parent, frameType, info)
	local frame = MR.CL.Panels:StartContainer("gui.mr.disps.name", parent, frameType, info)
	MR.CL.ExposedPanels:Set(frame, "displacements", "frame")
	...
	local displacementsLabel = vgui.Create("DLabel", panel)
		...
		displacementsLabel:SetText("gui.mr.disps.detected")
	...
	local displacementsCombobox = vgui.Create("DComboBox", panel)
		...
		MR.CL.ExposedPanels:Set(displacementsCombobox, "displacements", "combo")
	...
	local displacementsButton = vgui.Create("DButton", panel)
		...
		displacementsButton:SetText("gui.mr.copy")
	...
	local displacementsButton = vgui.Create("DButton", panel)
		...
		displacementsButton:SetText("gui.mr.apply")
	...
	local displacementsHint = vgui.Create("DLabel", panel)
		...
		displacementsHint:SetText("gui.mr.disps.tip")
