...
function Panels:SetLoad(parent, frameType, info)
	local frame = MR.CL.Panels:StartContainer("gui.mr.load", parent, frameType, info)
	...
	local loadButton = vgui.Create("DButton", panel)
		...
		loadButton:SetText("gui.mr.load")
	...
	local deleteButton = vgui.Create("DButton", panel)
		...
		deleteButton:SetText("gui.mr.delete")
		...
		deleteButton.DoClick = function()
			...
			local qPanel = vgui.Create("DFrame")
				qPanel:SetTitle("gui.mr.Load.prompt.name")
			...
			local text = vgui.Create("DLabel", qPanel)
				text:SetPos(40, 25)
				text:SetSize(275, 25)
				text:SetText("gui.mr.Load.prompt.text")
	...
	local setAutoButton = vgui.Create("DButton", panel)
		...
		setAutoButton:SetText("gui.mr.Load.setauto")
		setAutoButton:SetTooltip("gui.mr.Load.setauto_tip")
	...
	local progressBox = vgui.Create("DCheckBoxLabel", panel)
		...
		progressBox:SetText("gui.mr.Load.pb")
	...
	local loadCleanupBox = vgui.Create("DCheckBoxLabel", panel)
		...
		loadCleanupBox:SetText("gui.mr.cleanup.name")
	...
	local speedLabel = vgui.Create("DLabel", panel)
		...
		speedLabel:SetText("gui.mr.Load.speed.name")
