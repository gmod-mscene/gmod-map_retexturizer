...
function Panels:SetSkybox(parent, frameType, info)
	local frame = MR.CL.Panels:StartContainer("gui.mr.skybox.name", parent, frameType, info)
	...
	local skyboxPathLabel = vgui.Create("DLabel", panel)
		...
		skyboxPathLabel:SetText("gui.mr.skybox.path")
	...
	local skyboxCheckbox = vgui.Create("DCheckBoxLabel", panel)
		...
		skyboxCheckbox:SetText("gui.mr.skybox.tool")
